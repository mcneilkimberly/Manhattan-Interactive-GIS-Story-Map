...
var style_manhattan_tracts_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("manhattan_median_Household_Income_at_Age_35_rP_gP_p25");
    ...
    if (value >= 0.000000 && value <= 24845.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 24845.000000 && value <= 30864.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30864.000000 && value <= 34220.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34220.000000 && value <= 40395.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 40395.000000 && value <= 63170.000000) {
            style = [ new ol.style.Style({
